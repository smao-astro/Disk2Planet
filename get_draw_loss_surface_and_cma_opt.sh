...
echo "$GUILD_HOME"
guild compare -Fo onet:draw_loss_surface_gpu -u --csv "$GUILD_HOME"/draw_loss_surface.csv && guild compare -Fo onet:cma_opt -u --csv "$GUILD_HOME"/cma_opt.csv
